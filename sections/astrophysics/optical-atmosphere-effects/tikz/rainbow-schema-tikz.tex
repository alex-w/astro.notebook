\begin{tikzpicture}[
    ...
    \tkzDrawSegments[arrow=latex](A,R1 R1,R2 R2,R3 R3,R4 R4,L)
    \tkzDrawLines[dashed](C,R2 C,R3)
    
    \tkzMarkAngles[size = 0.25](C,R1,R2 C,R2,R3 C,R3,R4)
    \tkzMarkAngles[size = 0.3](R1,R2,C R2,R3,C R3,R4,C)
    \tkzLabelAngles[pos=0.4](C,R1,R2 C,R2,R3 C,R3,R4 R1,R2,C R2,R3,C R3,R4,C){\footnotesize $\beta$}
    ...
    \tkzInterLL(R4,L)(A,R1)
    \tkzGetPoint{W}
    \tkzMarkAngle[arc=l, mark=x, size=0.2, size=4pt](R1,W,L)
