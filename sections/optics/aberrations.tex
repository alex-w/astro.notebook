...
\begin{wrapfigure}{r}{0.5\tw}
    ...
    \begin{tikzpicture}
        \begin{axis} [
            ...
            \addplot[smooth, domain=0.3:2.5] table[x=l, y=n, col sep = comma] {data/crown-dispersion.csv};
        \end{axis}
    \end{tikzpicture}
...
\begin{wrapfigure}{r}{0.5\tw}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[smooth, domain=0.3:2.5] table[x=l, y=x, col sep = comma] {data/crown-dispersion.csv};
        \end{axis}
    \end{tikzpicture}
...
\begin{wrapfigure}[12]{r}{0.55\tw}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[smooth, gray] table[x=d, y=simple, col sep = comma] {data/shere-aberrations-lens.csv};
            \addplot[smooth] table[x=d, y=x, col sep = comma] {data/shere-aberrations-lens.csv};
...
\begin{wrapfigure}[12]{r}{0.55\tw}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[smooth, gray] table[x=d, y=simple, col sep = comma] {data/sphere-aberrations-mirror.csv};
            \addplot[smooth] table[x=d, y=x, col sep = comma] {data/sphere-aberrations-mirror.csv};
    ...
    \tikzsetnextfilename{thick-lens-coma-1}
        \begin{tikzpicture}
            \begin{axis} [
                ...
                \addplot[smooth, gray] table[x=d, y=x, col sep = comma] {data/coma.csv};
                \addplot[smooth] table[x=d, y=y, col sep = comma] {data/coma.csv};
    ...
    \begin{subcaptionblock}{0.49\tw}
        ...
        \begin{tikzpicture}
            \begin{axis} [
                ...
                \addplot[only marks, mark = o, mark options={scale=0.2, black}] table[x=x, y=y, col sep = comma] {data/coma.csv};
    ...
    \begin{subcaptionblock}[t]{0.49\tw}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[only marks, mark = o, mark options={scale=0.2, black}] table[x=x, y=y, col sep = comma] {data/distortion-xy.csv};
    ...
    \begin{subcaptionblock}[t]{0.49\tw}
        ...
        \begin{tikzpicture}
            \begin{axis} [
                ...
                \addplot[smooth, gray] table[x=alpha, y=tan, col sep = comma] {data/distortion-y.csv};
                \addplot[smooth] table[x=alpha, y=y, col sep = comma] {data/distortion-y.csv};
    ...
    \begin{subcaptionblock}[t]{0.27\tw}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[only marks, mark = o, mark options={scale=0.2, black}] table[x=x, y=y, col sep = comma] {data/distortion-types.csv};
            \end{axis}
        \end{tikzpicture}
    ...
    \begin{subcaptionblock}[t]{0.3\tw}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[only marks, mark = o, mark options={scale=0.2, black}] table[x=x_barrel, y=y_barrel, col sep = comma] {data/distortion-types.csv};
            \end{axis}
        \end{tikzpicture}
    ...
    \begin{subcaptionblock}[t]{0.33\tw}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[only marks, mark = o, mark options={scale=0.2, black}] table[x=x_pillow, y=y_pillow, col sep = comma] {data/distortion-types.csv};
            \end{axis}
        \end{tikzpicture}
