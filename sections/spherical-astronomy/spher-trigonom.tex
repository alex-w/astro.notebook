...
\begin{wrapfigure}[12]{r}{0.45\tw}
    ...
    \begin{tikzpicture}[tdplot_main_coords]
        ...
        \draw[tdplot_rotated_coords, anchor=north west] (0,\r,0) node {$G$};
        ...
        \tdplotCsLabelPoint{\r}{\lo}{90}{$(\lambda_0,0)$}{anchor=north west}
        \tdplotCsDrawPoint{\r}{\lo-90}{\i}
        \tdplotCsLabelPoint{\r}{\lo-90}{\i}{$P'$}{anchor=south east}
        \tdplotCsLabelPoint{\r}{0}{0}{}{label={[below]250:$\Delta \lambda$}}
      
        \tdplotCsDrawPoint{\r}{0}{0}
        \tdplotCsLabelPoint{\r}{0}{0}{$P$}{anchor=south west}
        ...
        \tdplotCsLabelPoint{\r}{\lo + 15}{85}{$i$}{anchor=west}
      
        \tdplotCsDrawPoint{\r}{0}{90}{}
        \tdplotCsLabelPoint{\r}{0}{90}{$(0,0)$}{anchor= south west, label distance=0.5}
