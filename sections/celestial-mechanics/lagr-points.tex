...
\begin{wrapfigure}[12]{r}{0.5\tw}
    \centering
    \vspace{-1pc}
    \tikzsetnextfilename{larg-points}
    \begin{tikzpicture}
        \def\d{3.5}
        \def\m{1}
        \def\M{3.5}
...
\begin{wrapfigure}[4]{r}{0.45\tw}
    \centering
    \vspace{-.5pc}
    \tikzsetnextfilename{larg-points-1-2}
    \begin{tikzpicture}
        \def\R{4}
        \def\m{1}
        \def\M{5}
...
\begin{wrapfigure}[4]{r}{0.4\tw}
    \centering
    \vspace{-1pc}
    \tikzsetnextfilename{larg-points-3}
    \begin{tikzpicture}
        \def\d{4}
        \def\m{1}
        \def\M{2.7}
...
\begin{figure}[h!]
    ...
    \begin{subcaptionblock}{0.47\tw}
        \centering
        \tikzsetnextfilename{larg-points-4-5_1}
        \begin{tikzpicture}
            \def\R{3.5}
            \def\m{1}
            \def\M{3}
    ...
    \begin{subcaptionblock}{0.47\tw}
        \centering
        \tikzsetnextfilename{larg-points-4-5_2}
        \begin{tikzpicture}
            \def\R{3.5}
            \def\m{1}
            \def\M{3}
