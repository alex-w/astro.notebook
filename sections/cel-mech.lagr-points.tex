...
\change{Рассмотрим также второй способ найти координаты точек $L_{4}$ и $L_5$:\\[0.5pc]
\footnotesize{Рассмотрим проекции данных сил на ось, перпендикулярную $\vec{r}_3$. Зададим ее вектором $\vec{r}_3^\perp = (y, -x)$. Получим:
	\begin{gather*}
