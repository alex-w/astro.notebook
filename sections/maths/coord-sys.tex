...
%		\draw[semithick, -latex] (O) -- (E3);
		...
		\draw (O) ellipse(0.75 and 0.3);
		\draw (O) ellipse(1.5 and 0.6);
		
		\draw [fill=white] (O) circle(0.03);
		\draw [fill=white] (M) circle(0.03);
		\draw [fill=white] (M') circle(0.03);
		
		\draw (0, 1.9) -- (0.184, 1.979) -- (0.184, 1.779); 
		
		\draw (1.1, 0) node[anchor=north]{$\vec{r}_0$};
%		\draw (0.66, 0.33) node[anchor=north]{$\vec{e}_2$};
%		\draw (0.25, 0.75) node[anchor=east]{$\vec{e}_3$};
		\draw (0.35, 1) node[anchor=east]{$\vec{r}$};
		\draw (1.1, 0) node[anchor=south]{$\varphi$};
		\draw (0.7, 1) node[anchor=west]{$h$};
		\draw (0.4, 1.85) node[anchor=south]{$r$};
